...
use [yarn workspaces](https://classic.yarnpkg.com/lang/en/docs/workspaces/) to manage
...
```ts
import type { autoGeneratedGraphQLQueryType } from "@app/graphql";
```
...
- [@app/web](./web/README.md) - the React frontend, powered by
  [Next.js](https://nextjs.org/)
- [@app/graphql](./graphql/README.md) - the autogenerated GraphQL types and
  powered by [GraphQL Code Generator](https://the-guild.dev/graphql/codegen)
